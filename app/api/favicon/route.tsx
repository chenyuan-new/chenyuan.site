...
const faviconMapper: { [key: string]: string } = {
  '(?:github.com)': 'https://chenyuan.site/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://chenyuan.site/favicons/twitter.png',
  'coolshell.cn': 'https://chenyuan.site/favicons/coolshell.png',
  'vercel.com': 'https://chenyuan.site/favicons/vercel.png',
  'nextjs.org': 'https://chenyuan.site/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://chenyuan.site/favicon_blank.png'
